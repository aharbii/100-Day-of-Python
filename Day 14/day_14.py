...
def pick_choices(celeb_keys, correct_answer=[]):
    ...
    if correct_answer != []:
        ...
        picked_choices.append(random.choice(celeb_keys))
        celeb_keys.remove(picked_choices[1])
        picked_choices = [[f"{picked_choices[0]}: {celeb[picked_choices[0]][0]}", celeb[picked_choices[0]][1]],
                          [f"{picked_choices[1]}: {celeb[picked_choices[1]][0]}", celeb[picked_choices[1]][1]]]
        you_win = False
